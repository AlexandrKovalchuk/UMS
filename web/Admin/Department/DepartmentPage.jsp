...
<div class="itemsBlock">
    <div>
        <form action="DepartmentPageController" method="post">
            ...
            <td colspan=2>
                <button onclick="submit"  class="topicButton"><h2>Create New Department</h2></button>
            </td>
        </form>
    </div>
    <br />
    <div>
        <form action="DepartmentPageController" method="post">
            ...
            <td colspan=2>
                <button onclick="submit"  class="topicButton"><h2>Update Department</h2></button>
            </td>
        </form>
    </div>
    <br />
    <div>
        <form action="DepartmentPageController" method="post">
            ...
            <td colspan=2>
                <button onclick="submit"  class="topicButton"><h2>Move Department</h2></button>
            </td>
        </form>
    </div>
    <br />
    <div>
        <form action="DepartmentPageController" method="post">
            ...
            <td colspan=2>
                <button onclick="submit"  class="topicButton"><h2>Delete Department</h2></button>
            </td>
        </form>
    </div>
    <br />
    <div>
        <form action="DepartmentPageController" method="post">
            ...
            <td colspan=2>
                <button onclick="submit"  class="topicButton"><h2>Show Info about Department</h2></button>
            </td>
        </form>
    </div>
    <br />
