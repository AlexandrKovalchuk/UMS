 ...
 */
public class Chair extends Structure  implements Serializable {
    ...
    ArrayList<Group> Groups5 = new ArrayList<Group>();
    ArrayList<Group> Groups6 = new ArrayList<Group>();
    ...
    public Chair(){}
    public Chair(String longName, String shortName,int ID, int facultyID, String tName) {
        super(longName, shortName,ID,tName);
        this.facultyID = facultyID;
        qs.add(new QueryBean(tName,"facultyID",facultyID));
    }
    ...
    public void moveGroupToArchive(Group group){
    ...
    public void moveGroupsOneCoursHiger(){

        for(Group i : Groups6){
            moveGroupToArchive(i);
        }
        Groups6.removeAll(Groups6);
        for (Group i : Groups5){
            Groups6.add(i);
            i.setCourseNumber(6);
        }
        Groups5.removeAll(Groups5);
        for (Group i : Groups4){
            Groups5.add(i);
            i.setCourseNumber(6);
        }
        Groups4.removeAll(Groups4);
        for (Group i : Groups3){
            Groups4.add(i);
            i.setCourseNumber(6);
        }
        Groups3.removeAll(Groups3);
        for (Group i : Groups2){
            Groups3.add(i);
            i.setCourseNumber(6);
        }
        Groups2.removeAll(Groups2);
        for (Group i : Groups1){
            Groups2.add(i);
            i.setCourseNumber(6);
        }
        Groups1.removeAll(Groups1);
    }
