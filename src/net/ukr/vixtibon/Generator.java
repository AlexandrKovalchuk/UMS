...
// PASSWORD CREATOR
    ...
    public ArrayList<Chair> openChairs(String name, String faculty, int facultyID, String tName){
        ...
        try(BufferedReader f =new BufferedReader(new FileReader(name))){
            ...
            for(;(str = f.readLine())!=null;) {
                ...
                int wave = 0;
                Chair chair = new Chair(parts[0], parts[1],chairIDCounter,facultyID, tName);
