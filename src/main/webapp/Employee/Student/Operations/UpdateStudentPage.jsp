        ...
        <form action="UpdateStudentPageController" method="post" accept-charset="UTF-8">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input class = "inputSettings inputEmployee" type="text" name="name" maxlength="40" required value="${student.getName()}">
                    </td>
                </tr>
                <tr>
                    <td class = "textLabel textLabelEmployeePage">Surname:</td>
                    <td>
                        <input class = "inputSettings inputEmployee" type="text" name="lastName" maxlength="50" required value="${student.getSecondName()}">
                    </td>
                </tr>
                <tr>
                    <td class = "textLabel textLabelEmployeePage">Middle Name:</td>
                    <td>
                        <input class = "inputSettings inputEmployee" type="text" name="fathersName" maxlength="40" required value="${student.getSurname()}">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class ="textLabel textLabelEmployeePage">
                        <input type="radio" name="sex" value="m" <c:if test = "${student.getSex() eq 'm'}">checked</c:if>>Male<br>
                        <input type="radio" name="sex" value="f" <c:if test = "${student.getSex() eq 'f'}">checked</c:if>>Female<br>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class = "inputSettings inputEmployee numericInput2" type="number" name="bday" maxlength="2" required value="${student.getDayOfBorn()}">
                    </td>
                </tr>
                <tr>
                    <td class = "textLabel textLabelEmployeePage">Month</td>
                    <td>
                        <input class = "inputSettings inputEmployee numericInput2" type="number" name="bmonth" maxlength="2" required value="${student.getMonthOfBorn()}">
                    </td>
                </tr>
                <tr>
                    <td class = "textLabel textLabelEmployeePage">Year</td>
                    <td>
                        <input class = "inputSettings inputEmployee numericInput4" type="number" name="byear" maxlength="4" required value="${student.getYearOfBorn()}">
                    </td>
                </tr>
                <tr>
                    <td class = "textLabel textLabelEmployeePage">Email:</td>
                    <td>
                        <input class = "inputSettings inputEmployee inputAdminPageLongNames" type="text" name="email" maxlength="100" required value="${student.getEmail()}">
                    </td>
                </tr>
                <tr>
                    <td class = "textLabel textLabelEmployeePage">Phone Number:</td>
                    <td>
                        <input class = "inputSettings inputEmployee" type="text" name="phoneNumber" maxlength="20" required value="${student.getPhoneNumber()}">
                    </td>
                </tr>
                <tr>
                    <td class = "textLabel textLabelEmployeePage">Address:</td>
                    <td>
                        <input class = "inputSettings inputEmployee inputAdminPageLongNames" type="text" name="address" maxlength="200" required value="${student.getAddress()}">
                    </td>
                </tr>
                <tr>
                    <td class = "textLabel textLabelEmployeePage">Passport data:</td>
                    <td>
                        <input class = "inputSettings inputEmployee inputAdminPageLongNames" type="text" name="pasport" maxlength="200" required value="${student.getPasport()}">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class = "inputSettings inputEmployee" type="text" name="indexBook" maxlength="100" required value="${student.getIndexBook()}">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class = "inputSettings inputEmployee inputAdminPageLongNames" type="text" name="login" maxlength="70" required value="${student.getLogin()}">
                    </td>
                </tr>
